...
### Ссылки на отчётные документы
- План по автоматизации тестирования [Plan.md](docs/Plan.md)
- Отчёт по итогам тестирования [Report.md](docs/Report.md)
- Отчёт о проведённой автоматизации [Summary.md](docs/Summary.md)
...
- Выполнить запросы в БД из тест-кейсов ТС01-ТС06, описанных в файле [Plan.md](docs/Plan.md)